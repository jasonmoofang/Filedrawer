...
Item {
    ...
    PlasmaExtras.ScrollArea {
        ...
        ListView {
            ...
            model: placesSource.data[targetfolder]["directories.all"].concat(
                                                placesSource.data[targetfolder]["files.all"])
            ...
            delegate: Item {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        Qt.openUrlExternally(targetfolder + model.modelData)
                    }
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            PlasmaComponents.Label {
                                text: jsGetIcon(model.modelData)
    ...
    function jsGetIcon(filename) {
      // anything more elegant than this seems to require C++ involvement
      // so screw that. You didn't see anything~~ ;)
      let map = {
        "323": "text-h323",
        "3g2": "video-3gpp2",
        "3gp": "video-3gpp",
      ...
      return map[extension] ? map[extension] : "none";
    }
